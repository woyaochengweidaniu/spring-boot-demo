...
import com.lcm.es.contants.ElasticsearchConstant;
import com.lcm.es.model.Person;
import com.lcm.es.service.PersonService;
...
public class SpringbootElasticsearchApplicationTests {
    ...
    public void updateTest() {
        Person person = Person.builder().age(33).birthday(new Date()).country("IDUpdate").id(3L).name("呵呵update").remark("test3_update").build();
        List<Person> list = new ArrayList<>();
        list.add(person);
