package com.lcm.es.template;

import com.lcm.es.SpringbootElasticsearchApplicationTests;
 ...
 */
public class TemplateTest extends SpringbootElasticsearchApplicationTests {
    @Autowired
