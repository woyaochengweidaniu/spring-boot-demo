package com.lcm.cache.redis.service;

import com.lcm.cache.redis.SpringbootCacheRedisApplicationTests;
...
public class UserServiceTest extends SpringbootCacheRedisApplicationTests {
    ...
    public void redisTemplateTest(){
        String k1 = redisTemplate.opsForValue().get("xkcoding:user:1");
        log.debug("【user】:" + k1);
    }
